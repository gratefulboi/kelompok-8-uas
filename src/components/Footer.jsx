            ...
            <div className="max-w-6xl mx-auto px-8">
                <div className="text-yellow-50 p-1 flex flex-col md:flex-row md:justify-between md:items-center">
                    ...
                    <div className="flex flex-col md:flex-row md:justify-end w-full md:w-5/12 mt-4 md:mt-0">
                        <div className="h-6 lg:h-16 w-auto mb-4 md:mb-0 md:mr-4 lg:mr-8">
                            <Link to="/Budaya">
                                <ReferenceItem title="Budaya" />
                            </Link>
                        </div>
                        <div className="h-6 w-auto mb-4 md:mb-0 lg:mr-8">
                            <Link to="/Wisata">
                ...
                <div className="absolute bottom-2 right-2 text-yellow-50 mt-3 lg:mt-0">
                    {loading ? (
                        ...
                        <div className="flex flex-col text-xs lg:text-sm lg:flex-row lg:items-center">
