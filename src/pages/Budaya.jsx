...
export default function Budaya() {
  ...
  return (
    ...
    <div className='m-3 lg:m-10 flex flex-col justify-between items-center'>
        ...
        <Card className='m-10 flex flex-col lg:flex-row w-11/12 rounded-2xl bg-krem shadow-xl' data-aos="fade-down">
          <div className='overflow-hidden lg:w-1/2 rounded-t-2xl rounded-bl-none lg:rounded-br-2xl lg:rounded-tl-none flex-grow lg:order-2'>
      ...
      >
        <div className='swiper-button-prev text-krem bg-hijau1'></div>
            <SwiperSlide className=' w-3/4 lg:w-4/6'>
              ...
              <h1 className="flex justify-center bg-krem rounded-b-2xl lg:text-2xl">Suku Batak Toba</h1>
            </SwiperSlide>
            <SwiperSlide className=' w-3/4 lg:w-4/6'>
              <div className="relative group overflow-hidden rounded-t-2xl">
              ...
              <h1 className="flex justify-center bg-krem rounded-b-2xl lg:text-2xl">Suku Karo</h1>
            </SwiperSlide>
            <SwiperSlide className=' w-3/4 lg:w-4/6'>
              <div className="relative group overflow-hidden rounded-t-2xl">
              ...
              <h1 className="flex justify-center bg-krem rounded-b-2xl lg:text-2xl">Suku Pak Pak</h1>
            </SwiperSlide>
            <SwiperSlide className=' w-3/4 lg:w-4/6'>
              <div className="relative group overflow-hidden rounded-t-2xl">
              ...
              <h1 className="flex justify-center bg-krem rounded-b-2xl lg:text-2xl">Suku Melayu</h1>
            </SwiperSlide>
            <SwiperSlide className=' w-3/4 lg:w-4/6'>
              <div className="relative group overflow-hidden rounded-t-2xl">
              ...
              <h1 className="flex justify-center bg-krem rounded-b-2xl lg:text-2xl">Suku Angkola</h1>
            </SwiperSlide>
        ...
        <div className='flex flex-row flex-wrap justify-center space-y' data-aos='fade-up'>
          <Card className={getCardClasses('gordang')} onClick={() => handleCardClick('gordang')}>
            <div className='w-full'>
              <img src={gambarGordangSambilan} className='rounded-t-2xl object-cover w-full h-full cursor-pointer'/>
            </div>
          ...
          <Card className={getCardClasses('taganing')} onClick={() => handleCardClick('taganing')}>
            <div className='w-full'>
              <img src={gambarTaganing} className='rounded-t-2xl object-cover w-full h-full cursor-pointer'/>
            </div>
            <CardContent className={styleMusic}>
          ...
          <Card className={getCardClasses('faritia')} onClick={() => handleCardClick('faritia')}>
            <div className='w-full'>
              <img src={gambarFaritia} className='rounded-t-2xl object-cover w-full h-full cursor-pointer' />
            </div>
            <CardContent className={styleMusic}>
          ...
          <Card className={getCardClasses('balobat')} onClick={() => handleCardClick('balobat')}>
            <div className='w-full'>
              <img src={gambarBalobat} className='rounded-t-2xl object-cover w-full h-full cursor-pointer'/>
            </div>
            <CardContent className={styleMusic}>
          ...
          <Card className={getCardClasses('doli')} onClick={() => handleCardClick('doli')}>
            <div className='w-full'>
              <img src={gambarDolidoli} className='rounded-t-2xl object-cover w-full h-full cursor-pointer'/>
            </div>
            <CardContent className={styleMusic}>
