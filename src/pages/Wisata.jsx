  ...
  return (
    <>
      ...
      <div className="container mx-auto mt-4 relative">
        <div className="w-full bg-gray-200 border border-gray-400" style={{ paddingBottom: '37.5%' }}>
      ...
      <div className="container mx-auto mt-4 flex">
        <div className="w-1/3 p-4 bg-yellow-200 border border-yellow-400 mr-4">
          ...
          <p>This is the content of the fourth box.</p>
        </div>
        {/* Fifth box */}
...
export default function Wisata() {
  return (
    <div>
      ...
      <div className="mb-12"> {/* Add larger margin bottom to create more space between sets */}
        <BoxSet 
          imageSrc={danauToba}
          text1="Text on the photo"
      ...
      <div className="mb-12"> {/* Add larger margin bottom to create more space between sets */}
        <BoxSet 
          imageSrc={danauToba}
          text1="Different text on the photo"
